...
const SellerAddBook = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const bookData = {
            ...
            imageURL: imageURL,
            oldPrice: parseFloat(data.price), // Add oldPrice
            newPrice: parseFloat(data.price), // Add newPrice
            coverImage: imageURL  // Add coverImage
        }
        ...
        try {
            ...
            const response = await axios.post(`${getBaseUrl()}/api/books/seller/create`, bookData, {
                headers: {
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            ...
            if (response.data.url) {
                setImageURL(`${getBaseUrl()}${response.data.url}`);
            } else {
